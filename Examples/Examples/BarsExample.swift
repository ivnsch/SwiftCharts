...
class BarsExample: UIViewController {
    ...
    private func barsChart(#horizontal: Bool) -> Chart {
        ...
        let (axisValues1, axisValues2) = (
            Array(stride(from: 0, through: 20, by: 2)).map {ChartAxisValueDouble($0, labelSettings: labelSettings)},
            Array(stride(from: 0, through: 14, by: 2)).map {ChartAxisValueDouble($0, labelSettings: labelSettings)}
        )
