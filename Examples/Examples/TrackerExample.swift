...
class TrackerExample: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let chartPoints = [(2, 2), (4, 4), (7, 1), (8, 11), (12, 0)].map{ChartPoint(x: ChartAxisValueDouble($0.0, labelSettings: labelSettings), y: ChartAxisValueDouble($0.1))}
        
        let chartPoints2 = [(2, 3), (3, 1), (5, 6), (7, 2), (8, 14), (12, 0)].map{ChartPoint(x: ChartAxisValueDouble($0.0, labelSettings: labelSettings), y: ChartAxisValueDouble($0.1))}
