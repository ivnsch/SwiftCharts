...
class AreasExample: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let chartPointsLayer1 = ChartPointsAreaLayer(axisX: xAxis, axisY: yAxis, innerFrame: innerFrame, chartPoints: chartPoints1, lineColor: c1, animDuration: 3, animDelay: 0, addContainerPoints: true)
        let chartPointsLayer2 = ChartPointsAreaLayer(axisX: xAxis, axisY: yAxis, innerFrame: innerFrame, chartPoints: chartPoints2, lineColor: c2, animDuration: 3, animDelay: 0, addContainerPoints: true)
        let chartPointsLayer3 = ChartPointsAreaLayer(axisX: xAxis, axisY: yAxis, innerFrame: innerFrame, chartPoints: chartPoints3, lineColor: c3, animDuration: 3, animDelay: 0, addContainerPoints: true)
